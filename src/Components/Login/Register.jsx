      ...
      <div className="h-[120vh]  bg-[#FAF7F2] flex flex-col justify-center items-center ">
        <div
          className={` 
            ...
            } bg-white border flex flex-col justify-center items-center border-gray-300 rounded-lg shadow-lg min-h-[400px] w-[350px]  ml-[20px] md:w-[700px] md:ml-[30px] lg:min-h-[370px] lg:w-[500px]`}
        >
          <div className="mb-[20px]">
            <p className="text-[10px]">{msg}</p>
            <p className="text-center text-[20px] font-bold">Sign Up Account</p>
          </div>
          <form onSubmit={Register} class="max-w-md mx-auto">
